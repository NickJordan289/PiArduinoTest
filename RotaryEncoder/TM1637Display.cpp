...
#include "TM1637Display.h" // I changed this line to be a local include change it back to <TM1637Display.h> if you wish to use it via the import library feature
#include <Arduino.h>
